...
public final class LabResultDisplayOrder {
    ...
    private static final Map<String, Integer> CODE_ORDER = Map.ofEntries(
            ...
            Map.entry("SEM-COL", 201),
            Map.entry("SEM-PH", 202),
            Map.entry("SEM-AT", 203),
            Map.entry("SEM-ABS", 204),
            Map.entry("SEM-LIQ", 205),
            Map.entry("SEM-COLL", 206),
            Map.entry("SEM-TSP", 207),
            Map.entry("SEM-VOL", 208),
            Map.entry("SEM-COUNT", 209),
            Map.entry("SEM-RAP", 210),
            Map.entry("SEM-SLO", 211),
            Map.entry("SEM-IMM", 212),
